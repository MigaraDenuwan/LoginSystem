...
export default function Register({ setAuthState, setUser }) {
  ...
  return (
    <div className='flex w-full h-screen'>
      {/* Section to add the background image and brand name */}
      <div className='hidden relative w-1/2 h-full lg:flex items-center justify-center bg-gray-200'>
        ...
        <div className='relative flex items-center justify-center'>
          ...
          <span className='absolute text-black text-4xl font-extrabold italic font-[Georgia, "Times New Roman", Times, serif]'>
            Pro_Mentor
          </span>
        </div>

        {/* Updated blur effect */}
        <div className='w-full h-1/2 absolute bottom-0 bg-white/10 backdrop-blur-10xl' />
      </div>
